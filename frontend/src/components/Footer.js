        ...
        <div className="footer-content">
          ...
          <div className="footer-column">
            ...
            <ul>
              ...
              <li><Link to="/stories">Yelooo Stories</Link></li>
          ...
          <div className="footer-column address-column">
            <h4>Mail Us:</h4>
            <p>
              Yelooo Private Limited,<br />
              123 Commerce Street,<br />
              Tech Park, Business District,<br />
              Bangalore, 560001,<br />
              Karnataka, India
            </p>
          ...
          <div className="footer-column address-column">
            ...
            <p>
              ...
              Bangalore, 560001,<br />
              Karnataka, India<br />
              CIN: U51109KA2024PTC000001<br />
              Telephone: <a href="tel:+911234567890">+91-123-4567890</a>
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="footer-bottom">
        <div className="footer-bottom-content">
          <div className="footer-bottom-links">
            <Link to="/become-seller" className="footer-bottom-link">
              <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
                <path d="M20 6h-2.18c.11-.31.18-.65.18-1 0-1.66-1.34-3-3-3-1.05 0-1.96.54-2.5 1.35l-.5.67-.5-.68C10.96 2.54 10.05 2 9 2 7.34 2 6 3.34 6 5c0 .35.07.69.18 1H4c-1.11 0-1.99.89-1.99 2L2 19c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zm-5-2c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zM9 4c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm11 15H4v-2h16v2zm0-5H4V8h5.08L7 10.83 8.62 12 11 8.76l1-1.36 1 1.36L15.38 12 17 10.83 14.92 8H20v6z"/>
              </svg>
              Become a Seller
            </Link>
            <Link to="/advertise" className="footer-bottom-link">
              <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
              </svg>
              Advertise
            </Link>
            <Link to="/gift-cards" className="footer-bottom-link">
              <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
            ...
            <Link to="/help" className="footer-bottom-link">
              <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
          ...
          <div className="footer-copyright">
            &copy; {new Date().getFullYear()} Yelooo.in
          </div>
        </div>
      </div>
    </footer>
