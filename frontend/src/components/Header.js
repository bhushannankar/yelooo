      ...
      <div className="header-mobile">
        ...
        <div className="mobile-category-strip">
          <div className="mobile-category-scroll">
            ...
            <button type="button" className="mobile-category-pill" onClick={() => navigate('/sellers-in-area')}>Sellers Near Me</button>
            ...
            <div className="header-mobile-drawer-body">
              ...
              {isLoggedIn && userRole === 'Admin' && (
                <>
                  ...
                  <Link to="/admin/customers" className="header-mobile-drawer-item" onClick={() => setMobileMenuOpen(false)}>Customer List</Link>
              ...
              {isLoggedIn && userRole === 'Customer' && (
                <>
                  ...
                  <Link to="/sellers-in-area" className="header-mobile-drawer-item" onClick={() => setMobileMenuOpen(false)}>Sellers in My Area</Link>
                </>
              )}
              {isLoggedIn && (
                ...
                <div className="dropdown" onMouseLeave={closeDropdown}>
                  ...
                  {activeDropdown === 'seller' && (
                    <div className="dropdown-menu">
                      ...
                      <Link to="/admin/customers" className="dropdown-item" onClick={closeDropdown}>
                        Customer List
                      </Link>
                    </div>
                  )}
                  ...
                  <div className="dropdown-menu profile-menu">
                    ...
                    {userRole === 'Customer' && (
                      <>
                        ...
                        <Link to="/sellers-in-area" className="dropdown-item" onClick={closeDropdown}>
                          <svg viewBox="0 0 24 24" fill="currentColor">
                            <path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/>
                          </svg>
                          Sellers in My Area
